...
const styles = StyleSheet.create({ header: { minHeight: 54, flexDirection: "row", alignItems: "center", gap: 8 }, leading: { minWidth: 44 }, copy: { flex: 1, gap: 2 }, title: { fontSize: layoutTokens.typography.title, fontWeight: "800", letterSpacing: -0.25 }, subtitle: { fontSize: layoutTokens.typography.caption, lineHeight: 18 }, action: { minWidth: 44, alignItems: "flex-end" } });
