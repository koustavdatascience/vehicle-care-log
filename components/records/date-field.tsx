...
export function DateField({ label, value, onChange, error, optional = false, minimumDate, maximumDate }: { label: string; value: string | null; onChange: (value: string | null) => void; error?: string; optional?: boolean; minimumDate?: string; maximumDate?: string }) {
