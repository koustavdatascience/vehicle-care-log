...
const styles = StyleSheet.create({ button: { minHeight: 48, borderWidth: 1, borderRadius: layoutTokens.radius.md, alignItems: "center", justifyContent: "center", paddingHorizontal: layoutTokens.spacing.lg }, content: { flexDirection: "row", gap: 8, alignItems: "center" }, label: { fontSize: layoutTokens.typography.label, fontWeight: "800" }, pressed: { opacity: 0.9, transform: [{ scale: 0.97 }] }, disabled: { opacity: 0.48 } });
