...
export default function HomeScreen() {
  ...
  return <ScreenContainer><FlatList
    ...
    ListHeaderComponent={<View style={styles.header}>
      <AppHeader title="Vehicle care" subtitle="A calm home for every kilometre" action={<VclIconButton icon="plus.circle.fill" label="Open add record menu" onPress={() => openAdd()} />} />
      ...
      <StatusBanner title="Private by design" message="Your records stay on this device and remain available without an internet connection." />
